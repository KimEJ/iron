            ...
            <div
                ...
                <div class="lg:py-6">
                    <div class="text-center lg:text-left">
                        ...
                        <h1 class="text-gray-800 pt-4 dark:text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                            모든 아이들이 <br>  <span
                                class="text-transparent bg-clip-text bg-gradient-to-br from-primary to-[#8cd66a]">행복한 세상</span>
                            을 꿈꾸며
                        </h1>
                    </div>

                    <p class="text-gray-600 dark:text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        이로운은 모든 아이들이 행복한 세상을 꿈꾸고, 이루어 나가는 사람들의 모임입니다. <br>
                    </p>
                    ...
                    <div class="pt-8 lg:pt-10 w-max mx-auto lg:mx-0">
                        <div class="flex items-center text-center flex-col sm:flex-row gap-4 sm:gap-0">
                            <div class="flex items-center">
                                ...
                                <img src="/images/people/red-fox-1310826_640.jpg" width="40" alt="avatar"
                                    class="w-10 h-10 rounded-full border-2 border-white dark:border-gray-400 object-cover -ml-2.5">
                                <img src="/images/people/tiger-2923186_640.jpg" width="40" alt="avatar"
                                    class="w-10 h-10 rounded-full border-2 border-white dark:border-gray-400 object-cover -ml-2.5">
                                <img src="/images/people/cat-1455468_640.jpg" width="40" alt="avatar"
                                    class="w-10 h-10 rounded-full border-2 border-white dark:border-gray-400 object-cover -ml-2.5">
                                <span
                ...
                <div class="lg:h-full  hidden md:flex">
                    ...
                    <div
                        ...
                        <div
                            class="absolute h-full z-10 p-1 -translate-y-1/2 top-1/2 right-3 rounded-3xl bg-white dark:bg-body shadow-lg shadow-box-shadow border border-box-border">
                            <img src="/images/FtZL0r4DZYk.jpg" alt="In studio" width="500" height="auto" loading="lazy"
