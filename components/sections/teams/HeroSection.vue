                ...
                <div class="lg:py-6">
                    <div class="text-center lg:text-left">
                        ...
                        <h1 class="text-gray-800 pt-4 dark:text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                            <span
                                class="text-transparent bg-clip-text bg-gradient-to-br from-primary to-[#8cd66a]">이로운</span>
                            세상을<br>만들고자 하는 <br> <span
                                class="text-transparent bg-clip-text bg-gradient-to-br from-primary to-[#8cd66a]">이룸이들</span>
                            의 모임.
                        </h1>
                    </div>
